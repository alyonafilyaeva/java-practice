...
public class Main {
    ...
    */
            ...
            switch (answer) {
                ...
                case 2 -> {
                    while (true) {
                        ...
                        } catch (CostException error) {
                            System.out.print("Ошибка ввода: " + error.getMessage());
                        }
    ...
    public static void validateCost(double cost) throws CostException {
        if (cost < 0) {
            throw new CostException("Стоимость не может быть отрицательной!\n");
        }
    }
